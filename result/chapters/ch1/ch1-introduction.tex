...
SQ3 is the Adaptability question: what has to be configurable for RP to fit the ten-driver depot and the multi-branch fleet without code changes? \Cref{sec:adaptability} answers it against the per-company configuration of soft-constraint weights and the planning horizon.
